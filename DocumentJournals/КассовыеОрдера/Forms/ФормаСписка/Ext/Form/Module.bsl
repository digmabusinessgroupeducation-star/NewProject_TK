...
Процедура ПриОткрытии(Отказ)
	...
	КонецЕсли;
	Если ЗначениеЗаполнено(ОтборСтатьяДДС) Тогда 
		ПараметрыОтбора.Вставить("СтатьяДДС", ОтборСтатьяДДС);
	КонецЕсли;
...
Процедура ОтборПодразделениеКомпанииПриИзменении(Элемент)
	...
	УстановитьОтборСписка(Список, Новый Структура("Подразделение", ОтборПодразделениеКомпании));	
...
&НаКлиенте
Процедура ОтборСтатьяДДСПриИзменении(Элемент)
	УстановитьОтборСписка(Список, Новый Структура("СтатьяДДС", ОтборСтатьяДДС));	
КонецПроцедуры
