...
Процедура КомандаОК(Команда)
	РедактированиеПериодическихСведенийКлиент.ОповеститьОЗавершении(ЭтаФорма, "СрокиОплатПоДоговорам", ОбъектВладелец);
КонецПроцедуры
	...
	Если НЕ ОтменаРедактирования Тогда
		...
		Если ТекДанные <> Неопределено Тогда
			...
			ИначеЕсли НЕ ЗначениеЗаполнено(ТекДанные.ТипОплаты) Тогда	
				СообщениеОбОшибке = НСтр("ru='Необходимо указать тип оплаты';uk='Необхідно вказати тип оплати'");
