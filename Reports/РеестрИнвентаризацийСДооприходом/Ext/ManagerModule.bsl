...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РеестрИнвентаризацийСДооприходом");
	НастройкиВарианта.Описание = НСтр("ru = 'Реестр инвентаризаций с дооприходом'; uk = 'Реєстр інвентаризацій з дооприбуткуванням'");
