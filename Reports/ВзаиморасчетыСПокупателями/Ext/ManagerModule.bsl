...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РасчетыСПокупателемПоДоговорам");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет по взаиморасчетам с покупателями по договорам'; uk = 'Звіт з взаєморозрахунків з покупцями за договорами'");
