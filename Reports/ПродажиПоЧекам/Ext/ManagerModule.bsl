...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ПродажиПоЧекам");
	НастройкиВарианта.Описание = НСтр("ru = 'Продажи OS по чекам'; uk = 'Продажі OS за чеками'");
