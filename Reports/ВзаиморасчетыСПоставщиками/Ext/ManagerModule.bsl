...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.ЗапасыИЗакупки);
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РасчетыСПоставщикамиПоДоговорам");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет по взаиморасчетам с поставщиками по договорам'; uk = 'Звіт з взаєморозрахунків з постачальниками за договорами'");
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.ЗапасыИЗакупки.Подсистемы.Закупки);
