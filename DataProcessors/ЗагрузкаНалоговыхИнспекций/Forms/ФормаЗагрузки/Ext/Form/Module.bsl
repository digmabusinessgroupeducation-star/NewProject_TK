...
Процедура ЗагрузитьДанные(Команда)
	...
	Если ОбщегоНазначенияТККлиент.РасширениеРаботыСФайламиПодключено() Тогда
...
Процедура ПриОткрытии(Отказ)
	...
	ВозможностьВыбораФайлов = ОбщегоНазначенияТККлиент.РасширениеРаботыСФайламиПодключено();
