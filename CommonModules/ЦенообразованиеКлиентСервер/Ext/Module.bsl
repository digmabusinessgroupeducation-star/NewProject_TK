...
// Возвращает числовое значение ставки НДС по значению спраовчника
//
// Параметры:
// 		СтавкаНДС - Справочник.СтавкиНДС - значение перечисления СтавкиНДС
//
...
Функция ПолучитьСтавкуНДСЧислом(Знач СтавкаНДС) Экспорт	
	...
	Возврат НДСОбщегоНазначенияПовтИсп.ПолучитьСтавкуНДСЧислом(СтавкаНДС);
