...
//	ИмяИзмерения - Имя измерения.
//
//	Требования:
//		Редактирование выполняется для регистров, где есть несколько измерений 
...
Процедура ПрочитатьЗаписьДляРедактированияВФормеПоИмениИзмерения(Форма, ИмяРегистра, ВедущийОбъект, ИмяИзмерения) Экспорт
