...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Если РольДоступна("ТК_Контролёр") 
		ИЛИ РольДоступна("ФС_Кладовщик")
			ИЛИ РольДоступна("ФС_Выпуск")
				ИЛИ РольДоступна("ТК_Сборка")Тогда
		
		Параметры.Вставить("ЗапускВРежимеРабочегоСтола", Истина);		
	КонецЕсли;
