...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РеестрЗадачиСервиДеск");
	НастройкиВарианта.Описание = НСтр("ru = 'Реестр зачач service desk'; uk = 'Реєстр зачач service desk'");
