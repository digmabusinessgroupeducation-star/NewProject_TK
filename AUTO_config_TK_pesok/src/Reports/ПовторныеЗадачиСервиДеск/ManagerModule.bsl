...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.ТК_ServiceDesk);

	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ПовторныеЗадачиСервиДеск");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет по повторяющимся задачам'; uk = 'Звіт з повторюваних завдань'");
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.ТК_ServiceDesk);
