...
Процедура ВыполнитьОбработку(Обработка, НакопленныеДанные) Экспорт
	...
	Если ЗначениеЗаполнено(КодСборкиОтвета) Тогда
		НакопленныеДанные.Вставить("КонтекстСеанса", РегистрыСведений.ТелеграмКонтекстСеансов.ПолучитьКонтекстСеанса(ИдентификаторЧата));
	...
	Если ИдентификаторЧата <> Неопределено Тогда
		...
		Если ВыборкаОбработка.ОчиститьКонтекст Тогда
			РегистрыСведений.ТелеграмКонтекстСеансов.ОчиститьКонтекстСеанса(ИдентификаторЧата);
		КонецЕсли;
