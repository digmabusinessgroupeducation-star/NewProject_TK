...
Процедура ДобавитьКомментарий(Знач Комментарий, СтруктураЗаписи, СтатусКомментария = Неопределено) Экспорт
...
Процедура ЗаписатьЖурналВыполненияОбработок(СтруктураЗаписи, Успешный) Экспорт
	...
	НаборЗаписей = РегистрыСведений.РезультатыВыполненияОбработок.СоздатьНаборЗаписей();
...
Функция ПараметрыОтбораРегистра()
	...
	ПоляОтбора = Новый Структура("Дата,ИдентификаторОбработки,КлючОбработки");
