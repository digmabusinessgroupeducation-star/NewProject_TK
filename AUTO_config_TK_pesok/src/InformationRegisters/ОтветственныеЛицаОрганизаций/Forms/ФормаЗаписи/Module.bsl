...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустой() Тогда
		...
		Запись.Период = НачалоДня(ТекущаяДатаСеанса());
		 ...
		 Если НЕ ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда
			Запись.Должность = ОтветственныеЛица.ПодобратьВероятнуюДолжностьОтветственногоЛица(Запись.ОтветственноеЛицо);
		КонецЕсли;
		
	КонецЕсли;
	
	Организация					= Запись.СтруктурнаяЕдиница;
	...
	Если ЗначениеЗаполнено(Запись.ОтветственноеЛицо) Тогда
		...
		Элементы.ОтветственноеЛицо.ЦветТекста	= ЦветаСтиля.ЦветОсобогоТекста;
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.Организация.Видимость				= ЗначениеЗаполнено(Форма.Организация);
...
Функция ПолучитьДолжностьФизЛица(СтруктурнаяЕдиница, ФизическоеЛицо, ОтветственноеЛицо)
	...
	Возврат ОтветственныеЛица.ПодобратьВероятнуюДолжностьОтветственногоЛица(ОтветственноеЛицо);
