...
Процедура КомандаОК(Команда)
	РедактированиеПериодическихСведенийКлиент.ОповеститьОЗавершении(ЭтаФорма, "ТК_УчетнаяПолитикаТорговыхПлощадок", ОбъектВладелец);
КонецПроцедуры
...
Процедура НаборЗаписейПередОкончаниемРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования, Отказ)
	Если НЕ ОтменаРедактирования Тогда
		...
		Если ТекДанные <> Неопределено Тогда
			...
			ИначеЕсли НЕ ЗначениеЗаполнено(ТекДанные.Организация) Тогда	
				СообщениеОбОшибке = НСтр("ru='Необходимо указать Организацию';uk='Необхідно вказати Організацію'");
