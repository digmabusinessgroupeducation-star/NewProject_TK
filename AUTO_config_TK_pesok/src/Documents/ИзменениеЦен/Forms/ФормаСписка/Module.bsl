...
&НаСервере
Процедура УстановитьРекНаценкиИПерепровестиНаСервере()
	...
	для Каждого  мСтрока Из МассивСтрок Цикл 
		...
		СтруктураДействий.Вставить("ПересчитатьНовуюЦенуПоПроцентуНаценки",ДокОбъект.ТипЦен.ПравилоРасчета);	
		
		ПараметрыОкргуления = Новый Структура;
		ПараметрыОкргуления.Вставить("ОкруглятьДо", ДокОбъект.ОкруглятьДо);
...
&НаКлиенте
Процедура УстановитьРекНаценкиИПерепровести(Команда)
	УстановитьРекНаценкиИПерепровестиНаСервере();
КонецПроцедуры
