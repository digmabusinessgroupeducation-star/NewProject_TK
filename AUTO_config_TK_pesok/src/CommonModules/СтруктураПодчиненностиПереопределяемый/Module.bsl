...
Процедура ПриПолученииПредставления(ТипДанных, Данные, Представление, СтандартнаяОбработка) Экспорт
	...
	Если ТипДанных = Тип("ДокументСсылка.ПеремещениеТоваров") тогда
		Операция = Данные.Ссылка.ХозОперация;
		Если Операция = Справочники.ХозОперации.ПеремещениеТоваровВФилиал тогда
			СтандартнаяОбработка = Ложь;
			Представление = "Перемещение товаров в филиал """+ Строка(Данные.Ссылка.ТорговаяПлощадкаПолучатель)+""" "+Данные.Ссылка.Номер+" от "+Данные.Ссылка.Дата;
		ИначеЕсли Операция = Справочники.ХозОперации.ПеремещениеТоваровИзФилиала Тогда
			СтандартнаяОбработка = Ложь;
			Представление = "Перемещение товаров из филиала """+ Строка(Данные.Ссылка.ТорговаяПлощадка)+""" "+Данные.Ссылка.Номер+" от "+Данные.Ссылка.Дата;
		КонецЕсли;
	КонецЕсли;
