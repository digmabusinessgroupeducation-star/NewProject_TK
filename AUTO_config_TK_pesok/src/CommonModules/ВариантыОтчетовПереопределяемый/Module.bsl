...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), НСтр("ru = 'Основные отчеты'; uk = 'Основні звіти'"));
	
	Разделы.Добавить(Метаданные.Подсистемы.НормативноСправочнаяИнформация, НСтр("ru = 'Справочники'; uk = 'Довідники'"));
	Разделы.Добавить(Метаданные.Подсистемы.CRMИМаркетинг, НСтр("ru = 'Отчеты маркетинг'; uk = 'Звіти маркетинг'"));
	Разделы.Добавить(Метаданные.Подсистемы.ЗапасыИЗакупки, НСтр("ru = 'Отчеты по закупкам'; uk = 'Звіти по закупівлям'"));
	Разделы.Добавить(Метаданные.Подсистемы.Продажи, НСтр("ru = 'Отчеты по розничным продажам'; uk = 'Звіти по роздрібним продажам'"));
	Разделы.Добавить(Метаданные.Подсистемы.Склад, НСтр("ru = 'Отчеты складские'; uk = 'Звіти для складів'"));
	Разделы.Добавить(Метаданные.Подсистемы.ДвижениеДенежныхСредств, НСтр("ru = 'Отчеты движений денежных средств'; uk = 'Звіти руху грошових коштів'"));	
	Разделы.Добавить(Метаданные.Подсистемы.Разработка, НСтр("ru = 'Отчеты разработка'; uk = 'Звіти розробка'"));
	Разделы.Добавить(Метаданные.Подсистемы.ТК_Дистрибуция, НСтр("ru = 'Отчеты дистрибуция'; uk = 'Звіти дистрибуція'"));
	Разделы.Добавить(Метаданные.Подсистемы.ТК_Анкетирование, НСтр("ru = 'Отчеты анкетирование'; uk = 'Звіти анкетування'"));
	Разделы.Добавить(Метаданные.Подсистемы.ТК_Казначейство, НСтр("ru = 'Отчеты казначейства'; uk = 'Звіти казначейства'"));
	Разделы.Добавить(Метаданные.Подсистемы.Производство, НСтр("ru = 'Отчеты по производству'; uk = 'Звіти по виробництву'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИОборотыТоваров);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиТоваров);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИОборотыПартий);
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВзаиморасчетыСПокупателями);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВзаиморасчетыСПоставщиками);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиПартийТоваров);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.НаценкиТоваров);
