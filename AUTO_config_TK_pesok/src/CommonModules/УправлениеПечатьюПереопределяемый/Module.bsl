...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//СписокОбъектов.Добавить(Документы.ПланАктивности);
	//СписокОбъектов.Добавить(Документы.ПротоколСогласованияЦен);
	...
	СписокОбъектов.Добавить(Документы.ТК_ТТН);
	СписокОбъектов.Добавить(Документы.ТК_АктСверкиВзаиморасчетов);
	СписокОбъектов.Добавить(Документы.ЗаказПоставщику);
	СписокОбъектов.Добавить(Документы.ИзменениеАссортимента);
	СписокОбъектов.Добавить(Документы.ТК_НалоговаяНакладная);
	СписокОбъектов.Добавить(Документы.ТК_Приложение2КНалоговойНакладной);
	СписокОбъектов.Добавить(Документы.АссортиментныйКомитет);
	СписокОбъектов.Добавить(Документы.СчетНаОплату);
	СписокОбъектов.Добавить(Документы.ТК_УстановкаМаркетинга);
	СписокОбъектов.Добавить(Документы.РасчетБонусов);
	СписокОбъектов.Добавить(Документы.ВыпускПродукции);
	СписокОбъектов.Добавить(Документы.НачислениеКоммунальныхУслуг);
