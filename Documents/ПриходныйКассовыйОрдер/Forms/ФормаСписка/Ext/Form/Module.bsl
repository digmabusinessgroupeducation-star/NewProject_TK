...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если ЗначениеЗаполнено(ПериодВыборки) Тогда 
		СтруктураБыстрогоОтбора.Вставить("ПериодВыборки", ПериодВыборки);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ОтборПодразделениеКомпании) Тогда 
		СтруктураБыстрогоОтбора.Вставить("ПодразделениеКомпании", ОтборПодразделениеКомпании);
	КонецЕсли;
	Если ЗначениеЗаполнено(ОтборКонтрагент) Тогда 
		СтруктураБыстрогоОтбора.Вставить("Контрагент", ОтборКонтрагент);
	КонецЕсли;
	Если ЗначениеЗаполнено(ОтборАвтор) Тогда 
		СтруктураБыстрогоОтбора.Вставить("Автор", ОтборАвтор);
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ОтборТорговаяПлощадка) Тогда 
		СтруктураБыстрогоОтбора.Вставить("ТорговаяПлощадка", ОтборТорговаяПлощадка);
	КонецЕсли;

	УстановитьОтборСписка(Список, СтруктураБыстрогоОтбора);	
