...
Процедура ПриОткрытии(Отказ)
	...
	КонецЕсли;
	Если ЗначениеЗаполнено(ОтборРеспондент) Тогда 
		ПараметрыОтбора.Вставить("Респондент", ОтборРеспондент);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ОтборОтветственный) Тогда 
		ПараметрыОтбора.Вставить("Интервьюер", ОтборОтветственный);
	КонецЕсли;
...
&НаКлиенте
Процедура ОтборРеспондентПриИзменении(Элемент)
	
	УстановитьОтборСписка(Список, Новый Структура("Респондент", ОтборРеспондент));
...
Процедура ОтборОтветственныйПриИзменении(Элемент)
	...
	УстановитьОтборСписка(Список, Новый Структура("Интервьюер", ОтборОтветственный));
